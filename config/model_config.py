...
_DATASET_HYPER_PARAMS = {
    ...
    "THUMOS":{
        ...
        "att_thresh": np.arange(0.15,1.0,0.05),
        "clf_thresh": np.arange(0.15,0.25,0.05),
    ...
    "ActivityNet":{
        ...
        "att_thresh": np.arange(0.005,0.025,0.005),
        "clf_thresh": np.arange(0.005,0.025,0.005),
    }} 
...
def build_args(dataset=None):
    ...
    args.clf_thresh = _DATASET_HYPER_PARAMS[args.dataset]["clf_thresh"]
    args.att_thresh = _DATASET_HYPER_PARAMS[args.dataset]["att_thresh"]
