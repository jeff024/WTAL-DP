...
class ACMDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        elif self.sample == "consective":
            con_vid_spd_feature = consecutive_sample(con_vid_feature, self.sample_segments_num)
        ...
        if self.phase == "train":
            return con_vid_spd_feature, vid_label_t, self.sample_segments_num / vid_len
        else:
            return vid_name, con_vid_spd_feature, vid_label_t, vid_len, vid_duration, self.sample_segments_num / vid_len
